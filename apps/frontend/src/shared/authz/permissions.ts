...
export const permissions = {
  ...
  audits: {
    evidenceRead: "audits.evidence.read",
    evidenceManage: "audits.evidence.manage",
  },
  documents: {
    read: "documents.read",
  ...
  governance: {
    ...
    complianceRead: "governance.compliance.read",
    complianceManage: "governance.compliance.manage",
    managementReviewRead: "governance.management_reviews.read",
    managementReviewManage: "governance.management_reviews.manage",
    managementReviewApprove: "governance.management_reviews.approve",
    policyRead: "governance.policies.read",
    policyManage: "governance.policies.manage",
    policyApprove: "governance.policies.approve",
  },
  requirements: {
  ...
  metrics: {
    ...
    adoptionRead: "metrics.adoption.read",
    adoptionManage: "metrics.adoption.manage",
  },
  releases: {
    read: "releases.read",
  ...
  operations: {
    ...
    automationRead: "operations.automation.read",
    automationManage: "operations.automation.manage",
    automationExecute: "operations.automation.execute",
  },
  learning: {
    read: "learning.training.read",
    manage: "learning.training.manage",
    approve: "learning.training.approve",
  },
  exceptions: {
    read: "exceptions.waivers.read",
    manage: "exceptions.waivers.manage",
    approve: "exceptions.waivers.approve",
  },
  assessment: {
    workspaceRead: "assessment.workspace.read",
    workspaceManage: "assessment.workspace.manage",
    workspaceReview: "assessment.workspace.review",
    controlsRead: "assessment.controls.read",
    controlsManage: "assessment.controls.manage",
  },
  knowledge: {
    read: "knowledge.read",
...
const rolePermissionMap: Record<string, readonly Permission[]> = {
  ...
  "operis:assessment_manager": [
    permissions.assessment.workspaceRead,
    permissions.assessment.workspaceManage,
  ],
  "operis:assessment_reviewer": [
    permissions.assessment.workspaceRead,
    permissions.assessment.workspaceReview,
  ],
  "operis:assessment_viewer": [
    permissions.assessment.workspaceRead,
  ],
...
export function getPermissionLabel(permission: Permission) {
  return {
    ...
    [permissions.audits.evidenceRead]: "Read Evidence Completeness",
    [permissions.audits.evidenceManage]: "Manage Evidence Completeness",
    ...
    [permissions.governance.complianceRead]: "Read Compliance Dashboard",
    [permissions.governance.complianceManage]: "Manage Compliance Dashboard",
    [permissions.governance.managementReviewRead]: "Read Management Reviews",
    [permissions.governance.managementReviewManage]: "Manage Management Reviews",
    [permissions.governance.managementReviewApprove]: "Approve Management Reviews",
    [permissions.governance.policyRead]: "Read Policies and Acknowledgements",
    [permissions.governance.policyManage]: "Manage Policies and Campaigns",
    [permissions.governance.policyApprove]: "Approve and Publish Policies",
    ...
    [permissions.metrics.adoptionRead]: "Read Adoption Scorecards",
    [permissions.metrics.adoptionManage]: "Manage Adoption Rules and Evaluations",
    ...
    [permissions.operations.automationRead]: "Read Operational Automation",
    [permissions.operations.automationManage]: "Manage Operational Automation",
    [permissions.operations.automationExecute]: "Execute Operational Automation",
    [permissions.learning.read]: "Read Training and Competency",
    [permissions.learning.manage]: "Manage Training and Competency",
    [permissions.learning.approve]: "Approve Training Catalog",
    [permissions.exceptions.read]: "Read Process Waivers",
    [permissions.exceptions.manage]: "Manage Process Waivers",
    [permissions.exceptions.approve]: "Approve Process Waivers",
    [permissions.assessment.workspaceRead]: "Read Assessor Workspace",
    [permissions.assessment.workspaceManage]: "Manage Assessor Workspace",
    [permissions.assessment.workspaceReview]: "Review Assessment Findings",
    [permissions.assessment.controlsRead]: "Read Control Mapping",
    [permissions.assessment.controlsManage]: "Manage Control Mapping",
