    ...
    public static class ApiErrorCodes
{
    ...
    public const string TailoringStandardReferenceRequired = "tailoring_standard_reference_required";
    public const string TailoringDeviationReasonRequired = "tailoring_deviation_reason_required";
    public const string TailoringReviewDueDateRequired = "tailoring_review_due_date_required";
    public const string TailoringCriteriaNotFound = "tailoring_criteria_not_found";
    public const string TailoringReviewNotFound = "tailoring_review_not_found";
    ...
    public const string WaiverScopeRequired = "waiver_scope_required";
    public const string WaiverExpiryRequired = "waiver_expiry_required";
    public const string WaiverCompensatingControlRequired = "waiver_compensating_control_required";
    public const string WaiverNotFound = "waiver_not_found";
    public const string WaiverCodeDuplicate = "waiver_code_duplicate";
    public const string CapaEffectivenessResultRequired = "capa_effectiveness_result_required";
    public const string CapaEffectivenessEvidenceRequired = "capa_effectiveness_evidence_required";
    public const string CapaReopenReasonRequired = "capa_reopen_reason_required";
    public const string AssessmentPackageScopeRequired = "assessment_package_scope_required";
    public const string AssessmentPackageNotFound = "assessment_package_not_found";
    public const string AssessmentPackageSharingRequiresFinding = "assessment_package_sharing_requires_finding";
    public const string AssessmentFindingTitleRequired = "assessment_finding_title_required";
    public const string AssessmentFindingNotFound = "assessment_finding_not_found";
    public const string AssessmentFindingEvidenceReferenceRequired = "assessment_finding_evidence_reference_required";
    public const string ControlCodeRequired = "control_code_required";
    public const string ControlMappingTargetRequired = "control_mapping_target_required";
    public const string AdoptionRuleScopeRequired = "adoption_rule_scope_required";
    public const string AdoptionRuleThresholdInvalid = "adoption_rule_threshold_invalid";
    public const string AdoptionRuleNotFound = "adoption_rule_not_found";
    public const string AdoptionRuleCodeDuplicate = "adoption_rule_code_duplicate";
    ...
    public const string AutomationJobNameRequired = "automation_job_name_required";
    public const string AutomationJobTypeRequired = "automation_job_type_required";
    public const string AutomationJobEvidenceRequired = "automation_job_evidence_required";
