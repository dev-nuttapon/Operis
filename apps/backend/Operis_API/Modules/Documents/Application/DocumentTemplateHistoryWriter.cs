...
public sealed class DocumentTemplateHistoryWriter(OperisDbContext dbContext, IHttpContextAccessor httpContextAccessor)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var entry = new DocumentTemplateHistoryEntity
        {
            Id = Guid.NewGuid(),
        ...
        dbContext.DocumentTemplateHistories.Add(entry);
