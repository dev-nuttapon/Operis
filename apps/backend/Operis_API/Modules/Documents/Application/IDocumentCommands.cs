...
public interface IDocumentCommands
{
    ...
    Task<DocumentVersionPublishResult> PublishDocumentVersionAsync(DocumentVersionPublishCommand request, CancellationToken cancellationToken);
    Task<DocumentVersionUnpublishResult> UnpublishDocumentVersionAsync(DocumentVersionUnpublishCommand request, CancellationToken cancellationToken);
