...
public sealed record CreateSecretRotationRequest(string Touchpoint, string SecretScope, string? EvidenceRef, DateTimeOffset PlannedAt, DateTimeOffset? RotatedAt, string? VerifiedBy, DateTimeOffset? VerifiedAt, string Status);
public sealed record UpdateSecretRotationRequest(string Touchpoint, string SecretScope, string? EvidenceRef, DateTimeOffset PlannedAt, DateTimeOffset? RotatedAt, string? VerifiedBy, DateTimeOffset? VerifiedAt, string Status);
...
public sealed record SecretRotationResponse(Guid Id, string Touchpoint, string SecretScope, string? EvidenceRef, DateTimeOffset PlannedAt, DateTimeOffset? RotatedAt, string? VerifiedBy, DateTimeOffset? VerifiedAt, string Status, DateTimeOffset CreatedAt, DateTimeOffset? UpdatedAt);
