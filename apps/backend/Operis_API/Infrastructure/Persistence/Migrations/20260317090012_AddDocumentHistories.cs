...
namespace Operis_API.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260317090012_AddDocumentHistories")]
    public partial class AddDocumentHistories : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "document_histories",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_document_histories", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_document_histories_document_id",
                table: "document_histories",
                column: "document_id");

            migrationBuilder.CreateIndex(
                name: "IX_document_histories_event_type",
                table: "document_histories",
                column: "event_type");

            migrationBuilder.CreateIndex(
                name: "IX_document_histories_occurred_at",
                table: "document_histories",
                column: "occurred_at");
        }
        ...
        {
            migrationBuilder.DropTable(name: "document_histories");
        }
    }
}
